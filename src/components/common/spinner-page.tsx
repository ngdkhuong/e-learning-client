...
const SpinnerDialog: React.FC<SpinnerDialogProps> = ({ isUploading }) => {
    ...
    return (
        <Fragment>
            <Dialog open={isUploading} size={'sm'} handler={handleOpen} placeholder={undefined}>
                <DialogBody placeholder={undefined}>
                    <div className="flex mt-5 justify-center items-center">
                        <HashLoader size={100} color="gray" loading={isUploading} />
                    </div>
                </DialogBody>
                <DialogFooter placeholder={undefined} className="mb-7 flex justify-center font-semibold">
