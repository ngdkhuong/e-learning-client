                            ...
                            <div className="flex items-center justify-between md:h-14 lg:h-16">
                                ...
                                {isLoggedIn && user === 'student' ? (
                                    <div className="hidden md:ml-5 md:flex items-center justify-between">
                                        <div className="">
                                            <Link to="/dashboard">
                                                <Button size="md" color="blue-gray" placeholder={undefined}>
                                                    Dashboard
                                                </Button>
                                            </Link>
                                        </div>
                            ...
                            <div className="border-t border-gray-700 pb-3 pt-4">
                                <div className="mt-3 space-y-1 px-2">
                                    ...
                                    <Link to="/instructor/login">
                                        <button className="w-full block rounded-md px-3 py-2 text-sm font-bold text-gray-200 bg-purple-800 hover:bg-purple-900 hover:text-white focus:outline-none focus:shadow-outline">
                                            Instructor Login
                                        </button>
                                    </Link>
                                </div>
