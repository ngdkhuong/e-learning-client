    ...
    return (
        <div className="pl-1">
            <div className="ml-3 mr-3 flex items-center justify-between">
                <div className="bg-white flex-1 rounded-md pb-5 pr-5 pl-5 border shadow-sm border-gray-200 mr-4">
                    <div className="flex items-center">
                        ...
                        <div>
                            <Typography variant="h6" color="blue-gray" className="pt-2" placeholder={undefined}>
                                Monthly revenue
                            </Typography>
            ...
            <div className="py-5 px-4">
                <Typography placeholder={undefined} variant="h3" color="blue-gray" className="mb-4">
            ...
            <div className="flex items-centered">
                <div className="py-5 px-4 w-6/12">
                    <Typography variant="h4" color="blue-gray" className="mb-4" placeholder={undefined}>
                        Trending Courses
                    </Typography>
