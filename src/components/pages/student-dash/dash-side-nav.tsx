...
const SideNav: React.FC = () => {
    ...
    return (
        <Card className="fixed top-0  h-full w-full max-w-[17rem] p-3 rounded-none" placeholder={undefined}>
            ...
            <List placeholder={undefined}>
                ...
                {NavItems.map(({ icon, name, path }, index) => {
                    return (
                        ...
                        >
                            <ListItem className="mt-2" selected={name === selected} placeholder={undefined}>
