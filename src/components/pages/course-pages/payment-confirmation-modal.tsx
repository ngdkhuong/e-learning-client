...
const PaymentConfirmationModal: React.FC<PaymentModalProps> = ({ open, setOpen, setUpdated, courseDetails }) => {
    ...
    return (
        <Fragment>
            <Dialog open={open} size="sm" handler={handleOpen} placeholder={undefined}>
                <DialogHeader placeholder={undefined}>
                    <div className="flex items-center justify-center">
                        <ExclamationCircleIcon className="h-8 w-8 text-yellow-500" />
                        <Typography variant="h5" color="gray" className="ml-2 font-semibold" placeholder={undefined}>
                ...
                <DialogBody divider placeholder={undefined}>
                    ...
                    <Typography variant="paragraph" color="gray" className="mt-2 mb-1" placeholder={undefined}>
                        {isFreeCourse ? (
                    ...
                    <Typography variant="paragraph" color="gray" placeholder={undefined}>
