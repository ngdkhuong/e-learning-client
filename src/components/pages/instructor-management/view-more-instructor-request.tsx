    ...
    return (
        <div className="bg-white rounded-md mt-2 px-4 py-6">
            ...
            <div className="px-4 py-4 sm:px-6 flex justify-end">
                <Button size="sm" className="mr-2" color="green" onClick={acceptRequest} placeholder={undefined}>
                    Approve
                </Button>
                <Button size="sm" color="red" onClick={handleReject} placeholder={undefined}>
                    Reject
                </Button>
            </div>
        </div>
